 ...
 */
+ (AVObject *)objectWithClassName:(NSString *)className;
 ...
 */
+ (AVObject *)objectWithoutDataWithClassName:(NSString *)className
 ...
 */
+ (AVObject *)objectWithClassName:(NSString *)className dictionary:(NSDictionary *)dictionary;
